"""
code/perception/detector/eval_utils.py — shared inference-and-score utilities for
code/train_nx6_heatmap.py (periodic val metric) and code/eval_nx6_heatmap.py
(final val/test/failcase evaluation).
RF-1 split of code/nx6_heatmap_eval_utils.py (docs/refactor_plan.md); zero logic change.
...
from code.perception.detector.data import HeatmapDataset, SplitCache, collate
from code.perception.detector.model import MAX_DEPTH_CLIP_M, TARGET_INTR, decode_single
