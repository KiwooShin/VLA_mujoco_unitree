"""
code/perception/detector/data.py — NX-6 TRAIN (heatmap variant): dataset loading, resizing,
target-heatmap construction, and augmentation for dataset/det_v1 and
dataset/det_failcases.
RF-1 split of code/nx6_heatmap_data.py (docs/refactor_plan.md); zero logic change.
...
from code.perception.detector.model import (
