...
RF-1: moved from code/steer.py to code/control/steer.py (see
code/steer.py, the old-path compat alias, and docs/refactor_plan.md).
"""
...
def _smoke_test() -> None:
    """Standalone smoke test (invoked by `python code/steer.py`).

    Raises:
        AssertionError: If any sanity check on the control law fails.
    """
