"""
code/data/dataset_maneuver.py — Dataset loader for the maneuver skill.

Role: the maneuver-conditioned (62-d proprio) dataset layer, used by
train_maneuver.py.

Extends PhaseParquetDataset's shape to include maneuver-specific conditioning:
...
Moved from code/dataset_maneuver.py (RF-1); see code/dataset_maneuver.py for
the old-path compat alias. This module intentionally duplicates rather than
imports PhaseParquetDataset's parsing logic (RF-1 no-consolidation invariant).
"""
