"""
code/datagen/gen_stand_keyframe.py — Run WBC settle ONCE offline and save the resulting
...
Role: single-file CLI (well under the 500-line budget; not split). Moved
from code/gen_stand_keyframe.py (RF-1).
"""
