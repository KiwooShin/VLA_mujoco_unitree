"""
code/datagen/gen_maneuver_dataset.py — DART dataset generator for maneuver skill.
...
Role: single-file CLI + rollout (under the 500-line budget as-is; not split
further per RF-1). Moved from code/gen_maneuver_dataset.py.
"""
...
from code.datagen.gen_dart_dataset import GaitPhaseTracker, build_proprio
