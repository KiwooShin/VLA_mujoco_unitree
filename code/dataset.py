"""
Dataset for GroundedNav student.

Three modes:
  1. SyntheticDataset  — schema-shaped random tensors; used for overfit gate
                         before real data from S3 lands.
...
ADR-001 canonical schema (per timestep):
...
Split policy: by EPISODE (no within-episode leakage).
"""
